...
FIXME 0033 (`monodefn-redundant-side-maps`) is open — `MonoDefn` carries side maps duplicated against `CheckResult.expr_types` / `method_resolutions`; the resolution is in flight.
