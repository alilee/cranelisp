...
- [Principle 20](principles/20-model-invariants-by-representation.md) — Model a cross-field invariant by representation; accessor-enforcement is the explicit fallback (S83 — motivating context: the recurring "180 locations" cross-field-invariant churn + the FIXME 0354 `got_slot`/`constrained_fn` SIGSEGV; user-directed representation-first reshape, Phase 2 ratification 2026-06-14)
