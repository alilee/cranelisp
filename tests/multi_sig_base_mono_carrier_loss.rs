...
// defect: class=carrier-loss locus=multi-sig-base dispatch resolved_target carrier (produced typecheck-side, backend-keyed-consumer.md §1.2) found=S112 owner=pending-qa-attribution
#[test]
