...
| Document | Description |
|----------|-------------|
| [Tracing](trace.md) | Pure tracing via first-class execution tree ADT, GOT interception, module-scoped |
| [Testing](testing.md) | Testing via inline modules, reflection, stdlib conventions |
