...
| Skill | Task | Status | Notes |
|-------|------|--------|-------|
| /typecheck | Fix multi-sig batch crash (ast.rs:193) | pending | 4 tests |
| /typecheck | Fix default method dispatch (wrong fn ptr) | pending | 3 tests |
| /typecheck | Fix parse-int Option constructor-to-type mapping | pending | 2 tests |
| /typecheck | Fix constructor as value (compile_var for data ctors) | pending | 1 test |
| /backend | Fix cache submodule resolution + startup load | pending | 2 tests |
| /backend | Fix link GOT init (standalone executable) | pending | 1 test |
| /backend | Fix linker.rs:231 — BL range limit for extern calls | pending | FIXME |
| /backend | Fix worker.rs:2011 — dep symbol compilation stub | pending | FIXME |
| /int | Fix file watching E2E (test env + timing) | pending | 11 tests |
| /int | Fix persistence edge cases | pending | 3 tests |
| /int | Wire run-tests special form in v4 pipeline | pending | 1 test |
| /int | Fix batch primitive scoping per §8.9.1 | pending | 1 test |
| /int | Remove worker.rs:1205 dead Pass 2 handlers | pending | FIXME |
| /int | Refactor worker.rs:2855 ModuleSuspendState signature | pending | FIXME |
| /arch | Fix session_v4.rs:3269 — CodegenInput for object codegen | pending | FIXME |
...
| Skill | Task | Status | Notes |
|-------|------|--------|-------|
| /repl | Create sprint demo repl/demos/ring4l.demo | pending | |
