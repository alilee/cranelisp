...
| `errors/` | Error-message catalogue, written as each error is confirmed | started — `trait-impl-diagnostics.md` (binder-position rejects; `deftrait`/`impl` declaration diagnostics; no-impl + return-poly `:Type` dispatch diagnostics) |
