...
| 0686 | /spec | open | `/bar` explicit in §8.5.1 enumeration (user-confirmed symmetric reading) |
...
### W1 — QA-first battery (Stage 1)
| Skill | Crate | Task | Status |
|---|---|---|---|
| /testing | sprint-wide | ~46 new cells per plan §8 (FIRST ACT: live RED-inventory verification vs the 31-RED accounting + the M2/§5.3 landed-already reconciliation flag); `// defect:` locus updates (F-R1, MS-P8, I-1) | pending |
| /spec | spec/ | 0686 one-liner: `/bar` explicit in §8.5.1 (doc-only, parallel-safe file-confined) | pending |
