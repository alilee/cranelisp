...
| 53 | Clean & Green (part 2) | 28 remaining failures: file watching E2E (11), multi-sig batch (4), default methods (3), persistence (3), parse-int Option (2), cache (2), constructor-as-value (1), run-tests (1), link GOT (1). Macro define-before-use. | all skills |
| 54+ | TBD | Ring 4 gate review, exemplar E2E, performance baseline, Ring 4 acceptance. | TBD |
