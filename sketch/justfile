...
test:
    ...
    cargo test --test run_tests -- --test-threads=1
...
# Profile REPL startup with samply (opens Firefox Profiler)
profile:
    cargo build
    samply record ./target/debug/cranelisp --run examples/hello.cl
