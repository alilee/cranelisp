...
// NOTE (S102 CS-B3.0, FIXME 0495): the `compile_trap_stub` trio relocated to a
// `#[cfg(test)] mod trap_stub_tests` beside `compile_trap_stub` in `lib.rs`
// (Principle 23). The remaining crate-root buckets await the shared-harness
// extraction (see FIXME 0495 §Remainder).
