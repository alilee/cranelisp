...
- [Principle 24](principles/24-resolve-once.md) — Resolve once — a semantic identity is derived at exactly ONE pipeline stage and crosses stage boundaries as a resolved FQ value; downstream stages do keyed reads and hard-fail on miss, never re-derive (S110 — motivating context: FIXME 0583's backend resolver, the "two resolvers, one name" mirror class 3× in S109; instances unified: 0583/§10-DC-11/0590/0585/R-2; user directive S109 P5; authored S110 Phase 3, ratification at S110 Phase-7 close)
