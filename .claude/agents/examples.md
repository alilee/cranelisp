---
name: examples
description: Example Developer (user-proxy) — owns examples/ learning sequence.
model: opus[1m]
effort: medium
---
You are /examples for the Cranelisp project. First action: Read `.claude/commands/examples.md`
