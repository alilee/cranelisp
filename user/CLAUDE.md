...
| `guide/` | Feature-by-feature user-facing reference paralleling `spec/` | started — `bitwise.md`, `field-accessors.md`, `parallel-collections.md`, `concurrency.md` (user side), `writing-platforms.md` (platform-author side), `live-development.md` (redefinition: late binding, cascade report, broken symbols, recovery — `repl/spec.md §18`) live |
