...
> Authored S101 Wave 5 as the user-mandated **lifetime-across-suspension recurring-class ruling** (per `memory/feedback_review_root_cause_and_duplication` escalation); formal ratification at the S101 Phase-7 close review per the sprint-close-only convention in `principles.md`.
