...
// FIXME: design/arch/fixmes/0119-harvest-tests-legacy-wave4-g9.md
// Owning crate: src/ (cranelisp binary; persistent-worker module post-FIXME-0109)
// Owning skill: /int
// Quarantined: 2026-05-03
//
// This file's assertions test Rust-internal state (persistent
// priority-worker observations via CompilerSession Rust API) with no
// e2e equivalent. Harvest into `#[cfg(test)]` unit tests inside the
