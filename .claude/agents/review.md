...
cranelisp adds, then your role contract at `.agents/skills/review/SKILL.md` — the
...
`review` in `.agents/skill-composition.toml`; when creating or editing a memory or
