...
pub(crate) fn sub_i64(a: i64, b: i64) -> i64 {
    a.wrapping_sub(b)
}
...
pub(crate) fn div_i64(a: i64, b: i64) -> i64 {
    if b == 0 {
...
pub(crate) fn add_f64(a: i64, b: i64) -> i64 {
    let result = f64::from_bits(a as u64) + f64::from_bits(b as u64);
    result.to_bits() as i64
}

pub(crate) fn sub_f64(a: i64, b: i64) -> i64 {
    let result = f64::from_bits(a as u64) - f64::from_bits(b as u64);
    result.to_bits() as i64
}

pub(crate) fn mul_f64(a: i64, b: i64) -> i64 {
    let result = f64::from_bits(a as u64) * f64::from_bits(b as u64);
    result.to_bits() as i64
}

pub(crate) fn div_f64(a: i64, b: i64) -> i64 {
    let result = f64::from_bits(a as u64) / f64::from_bits(b as u64);
    result.to_bits() as i64
}
...
pub(crate) fn eq_i64(a: i64, b: i64) -> i64 {
    (a == b) as i64
}

pub(crate) fn lt_i64(a: i64, b: i64) -> i64 {
    (a < b) as i64
}

pub(crate) fn gt_i64(a: i64, b: i64) -> i64 {
    (a > b) as i64
}

pub(crate) fn le_i64(a: i64, b: i64) -> i64 {
    (a <= b) as i64
}

pub(crate) fn ge_i64(a: i64, b: i64) -> i64 {
    (a >= b) as i64
}

pub(crate) fn neq_i64(a: i64, b: i64) -> i64 {
    (a != b) as i64
}
...
pub(crate) fn eq_f64(a: i64, b: i64) -> i64 {
    (f64::from_bits(a as u64) == f64::from_bits(b as u64)) as i64
}

pub(crate) fn lt_f64(a: i64, b: i64) -> i64 {
    (f64::from_bits(a as u64) < f64::from_bits(b as u64)) as i64
}

pub(crate) fn gt_f64(a: i64, b: i64) -> i64 {
    (f64::from_bits(a as u64) > f64::from_bits(b as u64)) as i64
}

pub(crate) fn le_f64(a: i64, b: i64) -> i64 {
    (f64::from_bits(a as u64) <= f64::from_bits(b as u64)) as i64
}

pub(crate) fn ge_f64(a: i64, b: i64) -> i64 {
    (f64::from_bits(a as u64) >= f64::from_bits(b as u64)) as i64
}

pub(crate) fn neq_f64(a: i64, b: i64) -> i64 {
    (f64::from_bits(a as u64) != f64::from_bits(b as u64)) as i64
}
...
pub(crate) fn not(b: i64) -> i64 {
    (b ^ 1) & 1
}

pub(crate) fn eq_bool(a: i64, b: i64) -> i64 {
    (a == b) as i64
}

pub(crate) fn neq_bool(a: i64, b: i64) -> i64 {
    (a != b) as i64
}
...
pub(crate) fn bit_and(a: i64, b: i64) -> i64 {
    a & b
}

pub(crate) fn bit_or(a: i64, b: i64) -> i64 {
    a | b
}

pub(crate) fn bit_xor(a: i64, b: i64) -> i64 {
    a ^ b
}

pub(crate) fn bit_not(x: i64) -> i64 {
    !x
}

pub(crate) fn shl(v: i64, amt: i64) -> i64 {
...
pub(crate) fn shr(v: i64, amt: i64) -> i64 {
