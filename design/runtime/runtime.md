...
| `ivar.rs` | 314 | Write-once cells for spec §12.4.3 lenient evaluation. State CAS PENDING → EVALUATING → RESOLVED; rayon `spawn` for sparked thunks; force blocks. Atomic discipline per Decision 13. | Stable. |
