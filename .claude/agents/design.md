...
cranelisp adds, then your role contract at `.agents/skills/design/SKILL.md` — the
...
`design` in `.agents/skill-composition.toml`; when creating or editing a memory or
...
You are acting as the `design` role. The dispatching coordinator's brief is your
