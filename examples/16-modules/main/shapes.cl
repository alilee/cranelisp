;; main/shapes.cl -- A module defining geometric types and operations
;;
;; This file is the nested child main/shapes.cl, so its module identity is
;; "main.shapes" (per spec/08-modules.md §8.2.5). It is loaded by main.cl
;; via (mod shapes). Demonstrates modules that define types (deftype)
;; alongside functions. Types and constructors are accessed as
;; main.shapes/Point, main.shapes/Circle, etc.
;;
...
(import [primitives [Int add-i64 mul-i64]])
